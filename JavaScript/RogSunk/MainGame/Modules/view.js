  ...
  const funcSinkSub = () => {
    ...
    */
    ...
    if (intNum === 15) {
      ...
      modModel.objSub.intSubX = modModel.constSubLeft;
      modModel.imgSub.style.top = modModel.constSubTop + "px";
      modModel.imgSub.style.setProperty(
        "--varSubShrink",
  ...
  window.setTimeout(() => {
    ...
    if (modModel.objPlayer.intLevel > 3) {
      ...
      switch (modModel.objPlayer.intLevel) {
        case 2:
          modModel.objSub.intSubSpeed = modModel.constSubLevel2Speed;
          break;
        case 3:
          modModel.objSub.intSubSpeed = modModel.constSubLevel3Speed;
          break;
      }
...
export const funcTimerClouds = () => {
  ...
  let intCloud1X = modModel.constCloud1X;
  let intCloud2X = modModel.constCloud2X;
  let intCloud3X = modModel.constCloud3X;
  let intCloud4X = modModel.constCloud4X;
  let intCloud5X = modModel.constCloud5X;
  let intCloud6X = modModel.constCloud6X;
  let intCloud7X = modModel.constCloud7X;
  ...
  function funcCloudsTimer() {
    ...
    if (intCloud1ShrinkAmt >= 130) {
      ...
      intCloud1X = modModel.constCloud1X;
      modModel.imgCloud1.style.left = intCloud1X + "px";
      //unclip
      modModel.imgCloud1.style.setProperty(
        "--varCloud1Shrink",
    ...
    if (intCloud2ShrinkAmt >= 130) {
      //move off left side of screen
      intCloud2X = modModel.constCloud2X;
    ...
    if (intCloud3ShrinkAmt >= 130) {
      //move off left side of screen
      intCloud3X = modModel.constCloud3X;
      //unclip
      modModel.imgCloud3.style.setProperty(
        "--varCloud3Shrink",
        `inset(0px 0px 0px 0px)`
    ...
    if (intCloud4ShrinkAmt >= 130) {
      //move off left side of screen
      intCloud4X = modModel.constCloud4X;
      modModel.imgCloud4.style.left = intCloud4X + "px";
    ...
    if (intCloud5ShrinkAmt >= 130) {
      //move off left side of screen
      intCloud5X = modModel.constCloud5X;
      modModel.imgCloud5.style.left = intCloud5X + "px";
      //unclip
      modModel.imgCloud5.style.setProperty(
        "--varCloud5Shrink",
    ...
    if (intCloud6ShrinkAmt >= 130) {
      //move off left side of screen
      intCloud6X = modModel.constCloud6X;
      modModel.imgCloud6.style.left = intCloud6X + "px";
    ...
    if (intCloud7ShrinkAmt >= 130) {
      //move off left side of screen
      intCloud7X = modModel.constCloud7X;
      modModel.imgCloud7.style.left = intCloud7X + "px";
...
export const funcTimerMoveFish = () => {
  ...
  let intFish1X = modModel.constFish1X;
  let intFish2X = modModel.constFish2X;
  let intFish3X = modModel.constFish3X;
  let intFish4X = modModel.constFish4X;
  ...
  function funcFishTimer() {
    ...
    if (intShrinkFish1Amt >= 130) {
      //move off left side of screen
      intFish1X = modModel.constFish1X;
      //unclip
      modModel.imgFish1.style.setProperty(
        "--varShrinkFish1",
        `inset(0px 0px 0px 0px)`
    ...
    if (intShrinkFish2Amt >= 130) {
      //move off left side of screen
      intFish2X = modModel.constFish2X;
      //unclip
      modModel.imgFish2.style.setProperty(
        "--varShrinkFish2",
        `inset(0px 0px 0px 0px)`
    ...
    if (intShrinkFish3Amt >= 130) {
      //move off left side of screen
      intFish3X = modModel.constFish3X;
      //unclip
      modModel.imgFish3.style.setProperty(
        "--varShrinkFish3",
        `inset(0px 0px 0px 0px)`
    ...
    if (intShrinkFish4Amt >= 130) {
      //move off left side of screen
      intFish4X = modModel.constFish4X;
      //unclip
      modModel.imgFish4.style.setProperty(
        "--varShrinkFish4",
        `inset(0px 0px 0px 0px)`
