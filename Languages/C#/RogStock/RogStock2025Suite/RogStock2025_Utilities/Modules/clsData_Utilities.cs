...
namespace RogStock2025_Utilities.Modules
{
    internal static class clsData_Utilities
    {
        ...
        //select queries
        public static readonly string CNST_STR_SELECT_STOCK_ITEMS = "SELECT * FROM " + CNST_STR_STOCK_ITEMS + " ORDER BY STKI_ItemID;";
        ...
        public static readonly string CNST_STR_SELECT_STOCK_LOC = "SELECT * FROM " + CNST_STR_STOCK_LOC + " ORDER BY LOC_ItemID;";
        public static readonly string CNST_STR_SELECT_STOCK_LOT = "SELECT * FROM " + CNST_STR_STOCK_LOT + " ORDER BY LOT_ItemID;";
        public static readonly string CNST_STR_SELECT_STOCK_UOM = "SELECT * FROM " + CNST_STR_STOCK_UOM + " ORDER BY STKU_Desc";
        public static readonly string CNST_STR_SELECT_STOCK_PRODUCTFAMILY = "SELECT * FROM " + CNST_STR_STOCK_PRODUCTFAMILY + ";";
        public static readonly string CNST_STR_SELECT_LOCTRN = "SELECT * FROM " + CNST_STR_LOCTRN + " ORDER BY LOCT_ItemID;";
        public static readonly string CNST_STR_SELECT_LOTTRN = "SELECT * FROM " + CNST_STR_LOTTRN + " ORDER BY LOTT_ItemID;";
        //TRN operation types
        ...
        //report names
        public static readonly string CNST_STR_REPORT_UOM = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptUOM.rdl";
        public static readonly string CNST_STR_REPORT_PRODUCTFAMILY = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptProductFamily.rdl";
        public static readonly string CNST_STR_REPORT_LOCATIONS = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptLocations.rdl";
        public static readonly string CNST_STR_REPORT_LOTS = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptLots.rdl";
        public static readonly string CNST_STR_REPORT_LOCTRN = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptLocTRN.rdl";
        public static readonly string CNST_STR_REPORT_LOTTRN = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptLotTRN.rdl";

        public static readonly string CNST_STR_REPORT_STOCKITEMS_NOFILTER = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptStockItems_NoSort.rdl";
        public static readonly string CNST_STR_REPORT_STOCKITEMS_UOM = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptStockItems_UOM.rdl";
        public static readonly string CNST_STR_REPORT_STOCKITEMS_PRODUCTFAMILY = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptStockItems_ProductFamily.rdl";
        public static readonly string CNST_STR_REPORT_STOCKITEMS_LOCLOT = "C:\\projects\\VisualStudio\\Csharp\\RogStock2025\\RogStock_Reports\\rptStockItems_LocLot.rdl";
        ...
        public static string strLoggedInUser = "";
            ...
            */
            ...
            try
            {
                using (SQLConn = new SqlConnection(CNST_STR_ODBC))
                {
                    SQLConn.Open();
                    SQLCmd = SQLConn.CreateCommand();
                    SQLCmd.CommandText = "SELECT * FROM " + CNST_STR_MENU_USERGROUPS + " WHERE USRGRP_User ='" + strUser + "' AND USRGRP_Group ='" + strGroup + "';";
                    SQLCmd.CommandType = CommandType.Text;
            ...
            */
            ...
            try
            {
                using (SQLConn = new SqlConnection(CNST_STR_ODBC))
                {
                    SQLConn.Open();
                    SQLCmd = SQLConn.CreateCommand();
                    SQLCmd.CommandText = "SELECT * FROM " + CNST_STR_MENU_USERGROUPS + " WHERE USRGRP_Group ='" + strUserGroup + "';";
                    SQLCmd.CommandType = CommandType.Text;
            ...
            try
            {
                using (SQLConn = new SqlConnection(CNST_STR_ODBC))
                {
                    ...
                    while (SQLRead.Read())
                    {
                        ...
                        if (strTable == CNST_STR_MENU_USERGROUPS)
                        {
                            CMBTemp.Items.Add(SQLRead[1].ToString());
                        }
                    }
