...
namespace RogStock2026_Utilities.Modules
{
    internal static class clsView_Utilities
    {
        ...
        //form/menu constants
        public static string CNST_STR_MENU_OPENFORMSCONTROL = "MNUOpenWindows";
        ...
        public static void ReadThemeData()
        {
            /*
             ...
             reads theme colours file: \Resources\rogsjobcrmplustheme.thm
            ...
            */
            ...
            strTemp = Modules.clsData_Utilities.CNST_STR_FOLDER_RESOURCEPATH + "\\" + Modules.clsData_Utilities.CNST_STR_FILE_CUSTOMTHEMEFILE;
        ...
        public static void RemoveFromOpenForms(string strText)
        {
            ...
            */
            ...
            aryTemp = frmMainForm.Controls.Find(CNST_STR_MENU_OPENFORMSCONTROL, true);
        ...
        public static void ShowForm(string strWhat)
        {
            ...
            */
            ...
            {
                if (frmTemp.Controls["PANTitle"].Controls["LBLTitle"].Text == strWhat)
                {
        ...
        public static void OpenForm(string strWhat)
        {
            ...
            */
            ...
            if (frmTemp != null)
            {
                ...
                //hide menu
                if (Convert.ToInt16(BTNTemp.Tag) == 1)
                {
                    BTNTemp = (Button)frmMainForm.Controls["BTNShowHide"];
        ...
        public static void FormLocationChanged(object sender, EventArgs e)
        {
            /*
               ...
               Stops form being moved over show menu button or main menus!
        ...
        public static bool ValueInCombobox(ComboBox CMBTemp, string strValue)
        {
            /*
             ...
             Validates contents of passed combobox to see if passed value is in the list
        ...
        public static void SetFormTitle(Form frmWhat)
        {
            ...
            */
            ...
            Modules.clsTables_Utilities.dicFormTitles.TryGetValue(frmWhat.Name, out strTemp);
            ...
            */
            ...
            foreach (Control ctlTemp in frmWhat.Controls)
            {
                if (ctlTemp is Label)
                {
                    ...
                    foreach (Modules.clsData_Utilities.TTYPETableInfo typInfo in Modules.clsData_Utilities.lstTableInfo)
                    {
        ...
        public static void PopulateComboBoxes(ComboBox CMBTemp, string strTable, string strKeyField, string strKeyFieldValue, string strSecondFieldName, string strSecondFieldValue,
                                              string strWHERE, bool blnDistinct, bool blnDesc)
        {
            /*
             
              Modified 29/03/2025 By Roger Williams

              added sort ability: blnDesc
              sorts descending if true
            ...
            try
            {
                using (SQLConn = new SqlConnection(Modules.clsData_Utilities.CNST_STR_ODBC))
                {
                    ...
                    if (strKeyField.Length != 0)
                    {
                        if (blnDesc)
                        {
                            SQLCmd.CommandText += " ORDER BY " + strKeyField + " DESC";
                        }
                    }
                    ...
                    while (SQLRead.Read())
                    {
                        //if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_CRM_JOBS_CONTRACTTYPE)
                        //{
                        //    CMBTemp.Items.Add(SQLRead[1].ToString());
                        //}
                        //if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_CRM_JOBS_HOURS)
                        //{
                        //    CMBTemp.Items.Add(SQLRead[1].ToString());
                        //}
                        //if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_CRM_JOBS_WHERE)
                        //{
                        //    CMBTemp.Items.Add(SQLRead[1].ToString());
                        //}
                        //if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_CRM_JOBS_STATUS)
                        //{
                        //    CMBTemp.Items.Add(SQLRead[1].ToString());
                        //}
                        //if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_CRM_JOBS)
                        //{
                        //    CMBTemp.Items.Add(SQLRead[0].ToString());
                        //}
                        //if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_CRM_EVENTS)
                        //{
                        //    CMBTemp.Items.Add(SQLRead[0].ToString());
                        //}
                        //if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_CRM_CONTACTS)
                        //{
                        //    CMBTemp.Items.Add(SQLRead[0].ToString());
                        //}
                        //if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_CRM_MAILSHOT_HEADER)
                        //{
                        //    CMBTemp.Items.Add(SQLRead[0].ToString());
                        //}
                        ...
                        //admin comboboxes
                        if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_LOGIN)
                        {
                            CMBTemp.Items.Add(SQLRead[1].ToString());
                        }
                        if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_GROUPS)
                        {
                            CMBTemp.Items.Add(SQLRead[0].ToString());
                        }
                        if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS)
                        {
                            CMBTemp.Items.Add(SQLRead[1].ToString());
                        }
                        if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_AREAS)
                        {
                            CMBTemp.Items.Add(SQLRead[1].ToString());
                        }
                        if (strTable == Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_USERGROUPS)
                        {
                            CMBTemp.Items.Add(SQLRead[0].ToString());
                        }
                    }
