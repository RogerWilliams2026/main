...
{
    /*
       Created 10/07/2026 By Roger Williams
             
       Allows custom theme

       uses:

       \resources\rogstock2026theme.thm
    ...
    */
    public partial class frmThemeMaintenance_Utilities : Form
    {
        ...
        public frmThemeMaintenance_Utilities()
        {
            InitializeComponent();
        }
        ...
        {
            /*
              Created 14/07/2026 By Roger Williams
        ...
        private void CustomKeyDown(object sender, KeyEventArgs e)
        {
            ...
            /*
             Created 09/07/2026 By Roger Williams
        ...
        private void SaveRecord()
        {
            /*
             ...
             saves theme to theme colours file: \Resources\rogstock2026theme.thm
             stores values from new theme array    
            
             creates backup copy before saving

            NOTE: for datagridview need to save the items in this order:
                  DataGridView
                  DefaultCellStyle
            ...
            */
            ...
            strTemp1 = Path.GetDirectoryName(Application.ExecutablePath) + @"\Resources\rogstock2026theme.thm";

            //if exists create backup copy
            if (File.Exists(strTemp1))
            {
                //get datetime for unique copy name
                strTemp2 = Path.GetDirectoryName(strTemp1) + @"\rogstock2026theme";
            ...
            {
                //Whoops!
                MessageBox.Show("Error Accessing Theme File!", "File Write Error\n\n" + ex.Message, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        {
            /*
              Created 11/07/2026 By Roger Williams
        ...
        public void GetPropertyColour()
        {
            /*
              ...
              Modified 15/07/2026 By Roger Williams
        ...
        public void PreviewChanges(bool blnLoad)
        {
            /*
             ...
             Modified 22/07/2026 By Roger Williams

             Replaced old code with single call to SetTheme which now supports passing an
             array to it with the theme colours

             Modified 17/07/2026 By Roger Williams
            ...
            */
            ...
            UpdateNewArray();
            Modules.clsView_Utilities.SetTheme(frmPreview, aryThemeColoursNew);
        }
        ...
        public int CopyToOldNewArray()
        {
            /*
             ...
             Created 12/07/2026 By Roger Williams
        ...
        {
            /*
              Created 16/07/2026 By Roger Williams
        ...
        { 
            ...
            e.Graphics.DrawRectangle(penTemp, 338, 62, frmPreview.Width +20, 350);
            pntTemp1.Y = 420;
            pntTemp1.X = 0;
            pntTemp2.Y = 420;
