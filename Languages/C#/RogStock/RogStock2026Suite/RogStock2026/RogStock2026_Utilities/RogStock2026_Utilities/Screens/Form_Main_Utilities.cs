...
namespace RogStock2026_Utilities.Screens
{
    public partial class frmMain : Form
    {
        ...
        {
            /*
                   Created 01/07/2026 By Roger Williams
        ...
        public void WindowMenuClickEvent(object sender, EventArgs e)
        {
            /*
                  ...
                  Created 07/08/2026 By Roger Williams
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            Modules.clsTables_Utilities.GetSchemaData();
            Modules.clsTables_Utilities.GetSQLSchemaTableKeys();
            Modules.clsTables_Utilities.GetFormTitles();

            //init custom sql error data if not found exit
            if (!Modules.clsData_Utilities.InitCustomErrorhandler(Modules.clsData_Utilities.CNST_STR_FOLDER_RESOURCEPATH + @"\Errorlist.res"))
            {
        ...
        {
            /*
             Created 13/03/2026 By Roger Williams
        ...
        {
            /*
               Created 26/06/2026 By Roger Williams
        ...
        private void MNUCascade_Click(object sender, EventArgs e)
        {
            ...
            Modules.clsView_Utilities.ArrangeChildForms(this, 1);
        }
        ...
        private void MNUHorizontal_Click(object sender, EventArgs e)
        {
            //Note: below only works when form has border!
            //this.LayoutMdi(MdiLayout.Cascade);
            Modules.clsView_Utilities.ArrangeChildForms(this, 2);
        }
        ...
        private void MNUVertical_Click(object sender, EventArgs e)
        {
            //Note: below only works when form has border!
            //this.LayoutMdi(MdiLayout.Cascade);
            Modules.clsView_Utilities.ArrangeChildForms(this, 3);
        }
