     ...
     //   bool blnOk = false;
        ...
        private void BindForm()
        {
            ...
            */
            ...
            this.BNSMenuItems.DataSource = this.DSTMenuItems.Tables[Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS];
        ...
        private void ResetForm(string strKeep, bool blnEnable)
        {
            ...
            */
            ...
            Modules.clsView_Utilities.PopulateComboBoxes(this.CMBMNU_MenuItemName, Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS, "", "", "", "", "",false, false);
            blnNew = false;
        }
        ...
        private void LoadRecord()
        {
            ...
            */
            ...
            string strSQL1 = "SELECT * FROM " + Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS + " WHERE MNU_MenuItemName ='" + this.CMBMNU_MenuItemName.Text + "';";
            ...
            try
            {
                using (SQLConn = new SqlConnection(Modules.clsData_Utilities.CNST_STR_ODBC))
                {
                    ...
                    if (SQLCmd.ExecuteScalar() != null)
                    {
                        ...
                        {
                            this.DSTMenuItems.Tables[Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS].Clear();
                        }

                        //////get record into into dataset
                        DADTemp = new SqlDataAdapter(strSQL1, SQLConn);
                        DADTemp.SelectCommand.CommandText = strSQL1;
                        DADTemp.Fill(DSTMenuItems, Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS);
            ...
            */
            ...
            try
            {
                using (SQLConn = new SqlConnection(Modules.clsData_Utilities.CNST_STR_ODBC))
                {
                    ...
                    SQLCmdMenuItems = new SqlCommand("DELETE FROM " + Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS + " WHERE MNU_MenuItemName = '" + this.CMBMNU_MenuItemName.Text + "';", SQLConn);
                    SQLCmdGroups = new SqlCommand("DELETE FROM " + Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_GROUPS + " WHERE GRP_MenuItem = '" + this.CMBMNU_MenuItemName.Text + "';", SQLConn);
                    //start transction
                    SQLTrans = SQLConn.BeginTransaction();
                    //assign commands to the transaction
                    SQLCmdMenuItems.Transaction = SQLTrans;
                    SQLCmdGroups.Transaction = SQLTrans;
            ...
            */
            ...
            if (Modules.clsView_Utilities.ValidateRequiredFields(this))
            {
                ...
                if (!blnNew)
                {
                    ...
                    if (this.DSTMenuItems.Tables[Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS].GetChanges() == null)
                    {
                ...
                try
                {
                    using (SQLConn = new SqlConnection(Modules.clsData_Utilities.CNST_STR_ODBC))
                    {
                        ...
                        try
                        {
                            if (!blnNew)
                            {
                                if (DSTMenuItems.Tables[Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS].Rows[0].RowState == DataRowState.Modified)
                                {
                                    //Update records!
                                    SQLCmdMenuItems.CommandText = "UPDATE " + Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS + " " +
                            ...
                            {
                                //add new records 
                                SQLCmdMenuItems.CommandText = "INSERT INTO " + Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS + " (MNU_MenuItemName, MNU_MenuItemObject, MNU_Type, MNU_DisplayWhere) " +
        ...
        private void frmMenuItems_Utilities_Load(object sender, EventArgs e)
        {
            ...
            Modules.clsView_Utilities.PopulateComboBoxes(this.CMBMNU_MenuItemName, Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_MENUITEMS, "", "", "", "", "", false,false);
            Modules.clsView_Utilities.PopulateComboBoxes(this.CMBMNU_DisplayWhere, Modules.clsTables_Utilities.CNST_STR_TABLE_MENU_AREAS, "", "", "", "", "", false,false);
            Modules.clsView_Utilities.UpdateStatusBar(this.STLStatus, "Mode: Edit");
        ...
        /*
          Created 07/07/2026 By Roger Williams
