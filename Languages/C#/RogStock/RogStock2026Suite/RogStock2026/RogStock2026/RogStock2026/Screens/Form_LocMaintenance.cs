        ...
        */
        ...
        private void ResetForm(string strKeep, bool blnEnable)
        {
            ...
            */
            ...
            if (this.DSTLoc != null)
            {
                try
                {
                    if (this.DSTLoc.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOC].GetChanges() != null)
                    {
        ...
        private void DeleteRecord()
        {
            ...
            */
            ...
            if (this.DSTLoc.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOC].Rows.Count == 0)
            {
                return;
            }
            ...
            try
            {
                ...
                SQLCmd.CommandText = "DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOC + " WHERE LOC_ItemID = '" + this.CMBLOC_ItemID.Text + "' AND LOC_Location = '" + this.CMBLOC_Location.Text + "';";
                SQLCmd.ExecuteNonQuery();
                //write TRN
                SQLCmd.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_LOCTRN + " (LOCT_ItemID, LOCT_Location, LOCT_Qty, LOCT_Operation) " +
                ...
                if (blnLocLot)
                {
                    ...
                    {
                        DADLot = new SqlDataAdapter("SELECT * FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " WHERE LOT_ItemID = '" + this.CMBLOC_ItemID.Text + "' AND LOT_Location = '" + this.CMBLOC_Location.Text + "';", SQLConnLot);
                        DSTLot = new DataSet();
                        ...
                        {
                            //create TRN lot
                            SQLCmd.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_LOTTRN + " (LOTT_ItemID, LOTT_Nbr, LOTT_Qty, LOTT_Location, LOTT_Operation) " +
                            ...
                            //delete existing lot
                            SQLCmd.CommandText = "DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + "  WHERE LOT_ID = " + DTRTemp["LOT_ID"] + ";";
                            //write LOT record
                            SQLCmd.ExecuteNonQuery();
                        }
                    }
                ...
                //reset form
                ResetForm("", false);
                Modules.clsView.PopulateComboBoxes(this.CMBLOC_ItemID, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS, "", "", "", "", "WHERE STKI_LocLot = 0", false, false);
                Modules.clsView.PopulateComboBoxes(this.CMBLOC_Location, Modules.clsTables.CNST_STR_TABLE_STOCK_LOC, "LOC_ItemID", this.CMBLOC_ItemID.Text, "", "", "", false, false);
        ...
        private void SaveRecord()
        {
            ...
            */
                ...
                */
                ...
                if (blnLocLot)
                {
                    ...
                    if (Convert.ToInt32(SQLCmd.Parameters["@ErrorCustom"].Value) == 0)
                    {
                        ...
                        SQLCmd.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_LOTTRN + " (LOTT_ItemID, LOTT_Nbr, LOTT_Location, LOTT_Qty, LOTT_Operation) " +
            ...
            if (this.DSTLoc != null)
            {
                ...
                if (this.DSTLoc.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOC].Rows.Count == 0 && !blnNew)
                {
                    return;
                }
            }
            ...
            if (Modules.clsView.ValidateRequiredFields(this))
            {
                try
                {
                    intBoolean = this.CHKLOC_NonNet.Checked == true ? -1 : 0;
                    ...
                    if (blnNew)
                    {
                        ...
                        {
                            SQLCmd.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOC + " (LOC_ItemID, LOC_Location, LOC_Qty, LOC_Description, LOC_NonNet) " +
                    ...
                    else
                    {
                        ...
                        //}
                            ...
                            SQLCmd.CommandText = "UPDATE " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOC + " SET LOC_Qty = " + this.NUDLOC_Qty.Value + ", LOC_Description = '" + this.TXTLOC_Desc.Text + "', LOC_NonNet = " + intBoolean + " WHERE LOC_ItemID = '" + this.CMBLOC_ItemID.Text +
                    ...
                    //reset form
                    ResetForm("", false);
                    Modules.clsView.PopulateComboBoxes(this.CMBLOC_ItemID, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS, "", "", "", "", "", false, false);
                    Modules.clsView.PopulateComboBoxes(this.CMBLOC_Location, Modules.clsTables.CNST_STR_TABLE_STOCK_LOC, "LOC_ItemID", this.CMBLOC_ItemID.Text, "", "", "", false, false);
        ...
        private void BindForm()
        {
            ...
            */
            ...
            this.BNSLoc.DataSource = this.DSTLoc.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOC];

            //clear bindings
            this.LBLDesc.DataBindings.Clear();
            this.TXTHidden.DataBindings.Clear();
            this.TXTLOC_Desc.DataBindings.Clear();
            this.CMBLOC_Location.DataBindings.Clear();
            this.CHKLOC_NonNet.DataBindings.Clear();
            ...
            this.CHKLOC_NonNet.DataBindings.Add("checked", this.BNSLoc, "LOC_NonNet", false, DataSourceUpdateMode.OnPropertyChanged);
        ...
        private void LoadRecord()
        {
            ...
            */
            ...
            try
            {
                ...
                this.SQLCmd.CommandText = "SELECT * FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOC + " WHERE LOC_ItemID = '" + this.CMBLOC_ItemID.Text + "' AND LOC_Location ='" + this.CMBLOC_Location.Text + "' ORDER BY LOC_Location;";
                this.DADLoc = new SqlDataAdapter(SQLCmd);
                this.DADLoc.Fill(this.DSTLoc, Modules.clsTables.CNST_STR_TABLE_STOCK_LOC);

                if (this.TXTHidden.Text.Length == 0)
                {
                    Modules.clsView.PopulateComboBoxes(this.CMBLOC_Location, Modules.clsTables.CNST_STR_TABLE_STOCK_LOC, "", "", "", "", "", false, false);
                }
                else
                {
                    Modules.clsView.PopulateComboBoxes(this.CMBLOC_Location, Modules.clsTables.CNST_STR_TABLE_STOCK_LOC, "LOC_ItemID", this.TXTHidden.Text, "", "", "", false, false);
        ...
        private bool InitData()
        {
            ...
            */
            ...
            try
            {
                ...
                Modules.clsView.PopulateComboBoxes(this.CMBLOC_ItemID, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS, "", "", "", "", "", false, false);  // "WHERE STKI_LocLot = 0");
        ...
        private void GetStockDescription()
        {
            ...
            */
            ...
            SQLCmdDesc = new SqlCommand("SELECT STKD_Desc FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION + " WHERE STKD_ItemID = '" + this.CMBLOC_ItemID.Text + "';", SQLConn);
            ...
            {
                SQLRead.Read();
                this.LBLDesc.Text = SQLRead["STKD_Desc"].ToString();
            }
            else
            {
                this.LBLDesc.Text = string.Empty; ;
            }
        ...
        private void Form_LocMaintenance_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            //set form captions
            Modules.clsView.SetFormCaptions(this, Modules.clsTables.CNST_STR_TABLE_STOCK_LOC);
