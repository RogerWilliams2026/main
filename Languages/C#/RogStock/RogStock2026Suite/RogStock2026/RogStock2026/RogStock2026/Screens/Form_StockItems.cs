    ...
    public partial class frmStockItems : Form
    {
        ...
        private bool InitData()
        {
            ...
            */
            ...
            try
            {
                ...
                DADTemp.Fill(this.DSTDataItems, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS);
                DADTemp.Fill(this.DSTDataItems, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS);

                DSTDataDescription = new DataSet();
                SQLCmd = new SqlCommand(Modules.clsTables.CNST_STR_SELECT_STOCK_DESCRIPTION, SQLConn);
                DADTemp = new SqlDataAdapter(SQLCmd);
                DADTemp.Fill(this.DSTDataDescription, Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION);

                DSTDataMedia = new DataSet();
                SQLCmd = new SqlCommand(Modules.clsTables.CNST_STR_SELECT_STOCK_MEDIA, SQLConn);
                DADTemp = new SqlDataAdapter(SQLCmd);
                DADTemp.Fill(this.DSTDataMedia, Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA);
                return true;
            }
            catch (Exception ex)
            {
        ...
        private void BindForm()
        {
            ...
            */
            ...
            BNSStock_Item.DataSource = DSTDataItems.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS];
            BNSStock_Description.DataSource = DSTDataDescription.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION];
        ...
        */
        ...
        private void LoadRecord()
        {
            ...
            */
            ...
            string strSQL1 = "SELECT * FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS + " WHERE " + Modules.clsTables.GetPrimaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS) + " ='" + this.CMBSTKI_ItemID.Text + "';";
            string strSQL2 = "SELECT * FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION + " WHERE " + Modules.clsTables.GetPrimaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION) + " ='" + this.CMBSTKI_ItemID.Text + "';";
            string strSQL3 = "SELECT * FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA + " WHERE " + Modules.clsTables.GetPrimaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA) + " ='" + this.CMBSTKI_ItemID.Text + "';";
...
//                    SQLConn.Open();
                    ...
                    if (SQLRead != null)
                    {
                        ...
                        {
                            DSTDataDescription.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION].Clear();
                            DSTDataItems.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS].Clear();
                            DSTDataMedia.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA].Clear();
                        }
                        ////get record into into dataset
                        DADTemp = new SqlDataAdapter(strSQL1, SQLConn);
                        DADTemp.SelectCommand.CommandText = strSQL1;
                        DADTemp.Fill(DSTDataItems, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS);
                        DADTemp.SelectCommand.CommandText = strSQL2;
                        DADTemp.Fill(DSTDataDescription, Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION);
                        DADTemp.SelectCommand.CommandText = strSQL3;
                        DADTemp.Fill(DSTDataMedia, Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA);

                //bindform
                BindForm();

                        //populate form 
                        //DARRow = DSTDataItems.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS].Rows[0];
                        ...
                        //DARRow = DSTDataDescription.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION].Rows[0];
                        ...
                        DRCRows = DSTDataMedia.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA].Rows;
                        //clear listview
      ...
      //      int intWritten = 0;
            ...
            try
            {
                ...
                //    SQLConn.Open();
                    ...
                    SQLCmdItems = new SqlCommand("DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS + " WHERE " + Modules.clsTables.GetPrimaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS) + " = '" + this.CMBSTKI_ItemID.Text + "';", SQLConn);
                    SQLCmdDesc = new SqlCommand("DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION + " WHERE " + Modules.clsTables.GetPrimaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION) + " = '" + this.CMBSTKI_ItemID.Text + "';", SQLConn);
                    SQLCmdMedia = new SqlCommand("DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA + " WHERE " + Modules.clsTables.GetPrimaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA) + " = '" + this.CMBSTKI_ItemID.Text + "';", SQLConn);
                    //start transction
                    ...
                    try
                    {
                        ...
                        if (this.CHKSTKI_LocLot.Checked)
                        {
                            ...
                            {
                                DADLot = new SqlDataAdapter("SELECT * FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " WHERE " + Modules.clsTables.GetPrimaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_LOT) + " = '" + this.CMBSTKI_ItemID.Text + "';", SQLConnLot);
                                DSTLot = new DataSet();
                                ...
                                foreach (DataRow DTRTemp in DSTLot.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT].Rows)
                                {
                                    //create TRN lot
                                    SQLCmdLots.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_LOTTRN + " (LOTT_ItemID, LOTT_Nbr, LOTT_Qty, LOTT_Location, LOTT_Operation) " +
                                    ...
                                    //delete existing lot
                                    SQLCmdLots.CommandText = "DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + "  WHERE " + Modules.clsTables.GetSecondaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_LOT) + " = " + DTRTemp[Modules.clsTables.GetSecondaryField(Modules.clsTables.CNST_STR_TABLE_STOCK_LOT)] + ";";
                                    //write LOT record
                                    SQLCmdLots.ExecuteNonQuery();
                                }
                            }
                ...
                try
                {
                    ...
                    //    SQLConn.Open();
                        ...
                        try
                        {
                            if (!blnNew)
                            {
                                if (DSTDataItems.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS].Rows[0].RowState == DataRowState.Modified)
                                {
                                    //Update records!
                                    intBoolean = this.CHKSTKI_LocLot.Checked == true ? -1 : 0;
                                    SQLCmdItems.CommandText = "UPDATE " + Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS + " " +
                                    ...
                                    //    strSQLError = Modules.clsData.SaveRecord(SQLConn, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS, this, true, SQLTrans);
                                ...
                                if (DSTDataDescription.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION].Rows[0].RowState != DataRowState.Unchanged)
                                {
                                    if (DSTDataDescription.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION].Rows[0].RowState == DataRowState.Modified)
                                    {
                                        SQLCmdDesc.CommandText = "UPDATE " + Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION + " " +
                            ...
                            else
                            {
                                //add new records 
                                intBoolean = this.CHKSTKI_LocLot.Checked == true ? -1 : 0;
                                SQLCmdItems.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS + " (STKI_ItemID, STKI_UOM, STKI_ProductFamily, STKI_Price, STKI_LocLot) " +
                                ...
                                SQLCmdDesc.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION + " (STKD_ItemID, STKD_Desc, STKD_LongDesc) " +
                            ...
                            if (blnNew)
                            {
                                ...
                                {                                                                                                                                                                                                                    //subitems start at 1
                                    SQLCmdMedia.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA + " (STKM_ItemID, STKM_Path, STKM_Type) VALUES ('" + this.CMBSTKI_ItemID.Text + "','" + this.LVMedia.Items[intNum].Text + "','" + this.LVMedia.Items[intNum].SubItems[1].Text + "');";
                                    SQLCmdMedia.ExecuteNonQuery();
                                }
                            }
                            else
                            {
                                ...
                                foreach (string strTemp in lstMediaCur)
                                {
                                    if (!lstMediaOld.Contains(strTemp))
                                    {
                                        ...
                                        foreach (ListViewItem LVITemp in this.LVMedia.Items)
                                        {
                                            ...
                                            {
                                                //add
                                                SQLCmdMedia.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA + " (STKM_ItemID, STKM_Path, STKM_Type) VALUES ('" + this.CMBSTKI_ItemID.Text + "','" + LVITemp.Text + "','" + LVITemp.SubItems[1].Text + "');";
                                                SQLCmdMedia.ExecuteNonQuery();
                                            }
                                        }
                                    }
                                ...
                                foreach (string strTemp in lstMediaOld)
                                {
                                    ...
                                    {
                                        //add
                                        SQLCmdMedia.CommandText = "DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_MEDIA + " WHERE STKM_ItemID ='" + this.CMBSTKI_ItemID.Text + "' AND STKM_Path ='" + strTemp + "';";
                                        SQLCmdMedia.ExecuteNonQuery();
                                    }
                                }
                            }
                            ...
                            if (this.CHKSTKI_LocLot.Checked == false)
                            {
                                ...
                                {
                                    SQLCmdItems.CommandText = "DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " WHERE LOT_ItemID = '" + this.CMBSTKI_ItemID.Text + "';";
                                    SQLCmdItems.ExecuteNonQuery();
                                }
                            }
        ...
        private bool CheckForChanges()
        {
            ...
            */
            ...
            if (DSTDataDescription.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION].GetChanges() != null)
            {
                intChangesMade  ++;
            }

            if (DSTDataItems.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS].GetChanges() != null)
            {
                intChangesMade++;
            }
        ...
        private void frmStockItems_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            { 
                Modules.clsView.PopulateComboBoxes(this.CMBSTKI_ItemID, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS, "", "", "", "", "", false, false);
                Modules.clsView.PopulateComboBoxes(this.CMBSTKI_ProductFamily, Modules.clsTables.CNST_STR_TABLE_STOCK_PRODUCTFAMILY, "", "", "", "", "", false, false);
                Modules.clsView.PopulateComboBoxes(this.CMBSTKI_UOM, Modules.clsTables.CNST_STR_TABLE_STOCK_UOM, "", "", "", "", "", false, false);
                ...
                Modules.clsView.SetFormCaptions(this, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS);
                Modules.clsView.SetFormCaptions(this, Modules.clsTables.CNST_STR_TABLE_STOCK_PRODUCTFAMILY);
                Modules.clsView.SetFormCaptions(this, Modules.clsTables.CNST_STR_TABLE_STOCK_UOM);
            }
        }
