        ...
        */
        ...
        private void ResetForm(string strKeep, bool blnEnable)
        {
            ...
            */
            ...
            if (this.DSTLoc != null)
            {
                this.DSTLoc.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOC].Rows.Clear();
            }
            if (this.DSTLot != null)
            {
                this.DSTLot.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT].Rows.Clear();
            }
        }
        ...
        private List<string> ValidateAllLocationQtys()
        {
            ...
            */
            ...
            if (blnLocLot)
            {
                ...
                tblTempLotEdit = this.DSTLot.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT].GetChanges();
                ...
                tblTempLotOld = this.DSTLot.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT];
        ...
        private void GetStockDescription()
        {
            ...
            */
            ...
            SQLCmdDesc = new SqlCommand("SELECT STKD_Desc FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_DESCRIPTION + " WHERE STKD_ItemID = '" + this.CMBSTKI_ItemID.Text + "';", SQLConn);
        ...
        private void SaveRecord()
        {
            ...
            */
            ...
            //data table vars
            DataTable TBLChangesLoc = this.DSTLoc.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOC].GetChanges();
            DataTable TBLChangesLot = this.DSTLot.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT].GetChanges();
            bool blnLocLot = Modules.clsData.CheckForLotTracking(this.CMBSTKI_ItemID.Text);
            ...
            if (Modules.clsView.ValidateRequiredFields(this))
            {
                try
                {
                    ...
                    if (blnLocLot)
                    {
                        ...
                        if (intSelectedLoc != -1)
                        //      if (this.DSTLot.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT].Rows.Count == 0)
                        {
                        ...
                        else
                        {
                            ...
                            foreach (DataRow DTRTemp in TBLChangesLot.Rows)
                            {
                                ...
                                //update existing Lot
                                SQLCmd.CommandText = "UPDATE " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " SET Lot_Qty = " + DTRTemp["Qty"] + " WHERE Lot_ID = " + DTRTemp["Lot Nbr"] + ";";
                                //write Lot record
                                SQLCmd.ExecuteNonQuery();
                            }
                        }
                    ...
                    { 
                        ...
                        foreach (DataRow DTRTemp in TBLChangesLoc.Rows)
                        {
                            ...
                            //update existing Loc
                            SQLCmd.CommandText = "UPDATE " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOC + " SET Loc_Qty = " + DTRTemp["Qty"] + " WHERE Loc_ItemID = '" + this.CMBSTKI_ItemID.Text +
        ...
        private void LoadRecord()
        {
            ...
            */
            ...
            try
            {
                ...
                this.SQLCmd = new SqlCommand("SELECT Loc_Location AS Location, Loc_Qty AS Qty, Loc_Description AS [Desc], Loc_NonNet AS [Non Net] FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOC + " WHERE Loc_ItemID = '" + this.CMBSTKI_ItemID.Text + "' ORDER BY Loc_Location;", SQLConn);
                this.DADLoc = new SqlDataAdapter(SQLCmd);
                this.DADLoc.Fill(this.DSTLoc, Modules.clsTables.CNST_STR_TABLE_STOCK_LOC);
                //set datagrid data
                this.DGVLocations.DataSource = this.DSTLoc.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOC];
        ...
        private void LoadLotsIntoDataGrid()
        {
            ...
            */
            ...
            this.SQLCmd = new SqlCommand("SELECT Lot_Location AS Location, Lot_ID AS [Lot Nbr], Lot_Qty AS Qty FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " WHERE Lot_ItemID = '" + this.CMBSTKI_ItemID.Text + "' AND Lot_Location = '" + this.DGVLocations.CurrentRow.Cells[0].Value.ToString() + "' ORDER BY Lot_ID;", SQLConn);
            this.DADLoc = new SqlDataAdapter(SQLCmd);
            this.DSTLot = new DataSet();
            this.DADLoc.Fill(this.DSTLot, Modules.clsTables.CNST_STR_TABLE_STOCK_LOT);
           ...
           // //}
            //else
            //{
                this.DGVLots.DataSource = this.DSTLot.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT];
        ...
        private void BTNUndo_Click(object sender, EventArgs e)
        {
            ...
            */
            this.DSTLoc.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOC].RejectChanges();
            this.DSTLot.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT].RejectChanges();
        }
