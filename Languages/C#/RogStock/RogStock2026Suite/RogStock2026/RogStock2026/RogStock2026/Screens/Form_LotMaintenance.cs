        ...
        */
        ...
        private void ResetForm(string strKeep, bool blnEnable)
        {
            ...
            */
            ...
            if (this.DSTLOT != null)
            {
                if (this.DSTLOT.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT].GetChanges() != null)
                {
        ...
        private void ActivateLocationComboBox()
        {
            ...
            Modules.clsView.PopulateComboBoxes(this.CMBLOT_Location, Modules.clsTables.CNST_STR_TABLE_STOCK_LOC, "LOC_ItemID", this.CMBLOT_ItemID.Text, "", "", "", false, false);
        ...
        private void DeleteRecord()
        {
            ...
            */
            ...
            if (this.DSTLOT.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT].Rows.Count == 1)
            {
            ...
            SQLCmdLot = new SqlCommand("SELECT LOT_Qty FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " WHERE LOT_ItemID = '" + this.CMBLOT_ItemID.Text + "' AND LOT_Location = '" +
            ...
            try
            {
                ...
                //delete lot
                SQLCmd.CommandText = "DELETE FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " WHERE LOT_ItemID = '" + this.CMBLOT_ItemID.Text + "' AND LOT_ID = " + this.CMBLOT_Nbr.Text + ";";
                SQLCmd.ExecuteNonQuery();
                //save changes
                ...
                //reset form
                ResetForm("", false);
                Modules.clsView.PopulateComboBoxes(this.CMBLOT_ItemID, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS, "", "", "", "", "", false, false);
                Modules.clsView.PopulateComboBoxes(this.CMBLOT_ItemID, Modules.clsTables.CNST_STR_TABLE_STOCK_LOT, "", "", "", "", "", false, false);
        ...
        private void SaveRecord()
        {
            ...
            */
            ...
            if (Modules.clsView.ValidateRequiredFields(this))
            {
                try
                {
                    intBoolean = this.CHKLOT_NonNet.Checked == true ? -1 : 0;
                    ...
                    SQLCmd.Transaction = SQLTransaction;
                    //update LOT record
                    SQLCmd.CommandText = "UPDATE " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " SET LOT_Qty = " + this.NUDLOT_Qty.Value + ", LOT_NonNet = " + intBoolean + " WHERE LOT_ID = " + this.CMBLOT_Nbr.Text + ";";
                    SQLCmd.ExecuteNonQuery();
                    //write LOT TRN record
                    SQLCmd.CommandText = "INSERT INTO " + Modules.clsTables.CNST_STR_TABLE_LOTTRN + " (LOTT_ItemID, LOTT_Nbr, LOTT_Qty, LOTT_Location, LOTT_Operation) " +
                    ...
                    ResetForm("", false);
                    Modules.clsView.PopulateComboBoxes(this.CMBLOT_ItemID, Modules.clsTables.CNST_STR_TABLE_STOCK_ITEMS, "", "", "", "", "", false, false);
                    // Modules.clsView.PopulateComboBoxes(this.CMBLOT_Nbr, Modules.clsData.CNST_STR_TABLE_STOCK_LOT, "", "", "", "");
        ...
        private void BindForm()
        {
            ...
            */
            ...
            this.BNSLOT.DataSource = this.DSTLOT.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT];

            //clear bindings
            this.TXTHidden.DataBindings.Clear();
            this.CHKLOT_NonNet.DataBindings.Clear();
            ...
            this.CHKLOT_NonNet.DataBindings.Add("checked", this.BNSLOT, "LOT_NonNet", false, DataSourceUpdateMode.OnPropertyChanged);
        ...
        private void LoadRecord()
        {
            ...
            */
            ...
            try
            {
                ...
                this.SQLCmd.CommandText = "SELECT * FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOT + " WHERE LOT_ID ='" + this.CMBLOT_Nbr.Text + "';";
                this.DADLOT = new SqlDataAdapter(SQLCmd);
                this.DADLOT.Fill(this.DSTLOT, Modules.clsTables.CNST_STR_TABLE_STOCK_LOT);

                //get location qty and total lot qtys
                this.SQLCmd.CommandText = "SELECT * FROM " + Modules.clsTables.CNST_STR_TABLE_STOCK_LOC + " WHERE LOC_ItemID ='" + this.CMBLOT_ItemID.Text + "' AND LOC_Location ='" + this.CMBLOT_Location.Text + "';";
                ...
                tblLot = DSTLOT.Tables[Modules.clsTables.CNST_STR_TABLE_STOCK_LOT];
        ...
        private void ClearLotControls() 
        {
            ...
            this.CHKLOT_NonNet.Checked = false;
        }
        ...
        private void frmLotMaintenance_Load(object sender, EventArgs e)
        {
            ...
            if (Modules.clsData.CheckForStockItems())
            {
                if (Modules.clsData.CheckForLots())
                {
                    ...
                    //set form captions
                    Modules.clsView.SetFormCaptions(this, Modules.clsTables.CNST_STR_TABLE_STOCK_LOT);
        ...
        private void CMBLOT_Location_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            ClearLotControls();
            this.CMBLOT_Nbr.Text = String.Empty;
            Modules.clsView.PopulateComboBoxes(this.CMBLOT_Nbr, Modules.clsTables.CNST_STR_TABLE_STOCK_LOT, "LOT_Location", this.CMBLOT_Location.Text, "", "", "", false, false);
